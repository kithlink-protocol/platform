    ...
    <main id="main-content" className="container prose">
      ...
      {submitted ? (
        <>
          ...
          <p><Link href="/applications">View my applications</Link></p>
        </>
      ) : (
        <>
          ...
          <form onSubmit={onSubmit}>
            <div className="form-row">
              ...
              <textarea id="why_this_pet" name="why_this_pet" rows={5} className="input"
                value={whyThisPet} onChange={e => setWhyThisPet(e.target.value)} />
            </div>
